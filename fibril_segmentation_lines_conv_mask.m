...
function [Img_skel, lines, Img_smooth2, Img_bw_final] = fibril_segmentation_lines_conv_mask(Img, bin_mask, winSize, convlength, ignore_sm, boxsize, resize_factor, T, output_file, mout, winDelta)
...
Img_smooth_edge(bin_mask==1) = -99; % big penalty for including a masked pixel  
