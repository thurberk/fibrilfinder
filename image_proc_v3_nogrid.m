function image_proc_v3_nogrid(Img_raw,resize_factor,grid_edge,winSize,convlength,ignore_sm,boxsize,T,maskT,relion_file,output_file,mout,maskin,Img_mask,winDelta)
% container function for image processing
% no carbon grid removal step
