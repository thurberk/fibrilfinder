...
function [Img_skel, lines, Img_smooth2, Img_bw_final] = fibril_segmentation_lines_conv(Img, winSize, convlength, ignore_sm, boxsize, resize_factor, T, output_file, mout)
