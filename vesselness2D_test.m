...
for j = 1:length(sigmas)
    ...
    response = abs((Lambda2 - Lambda1).*Lambda2.*Lambda_rho.* 27) ./ (abs(Lambda2.*2 - Lambda1) + Lambda_rho).^3;  
    ...
    clear response Lambda1 Lambda2 Lambda3
end
