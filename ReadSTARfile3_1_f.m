...
optics_scan_n = 28; % was 28, may need increase/decrease based on number of optics variables

string_vars = ["_rlnOpticsGroupName", "_rlnImageName", "_rlnMicrographName", ...
"_rlnMtfFileName", "_rlnCtfImage", "_rlnMicrographMovieName", ...
"_rlnCtfPowerSpectrum", "_rlnMicrographMetadata"];
...
int_vars = ["_rlnOpticsGroup", "_rlnImageSize", "_rlnImageDimensionality", ...
    ...
    "_rlnAnglePsiFlip", "_rlnCtfDataAreCtfPremultiplied", "_rln3DFlipFlag"]; 
...
float_vars = ["_rlnCoordinateX", "_rlnCoordinateY", "_rlnAngleRotPrior", ...
    ...
    "_rlnAnglePsiPriorStart", "_rlnCtfAstigmatism", "_rlnProbClass1", ...
    "_rlnProbClass2", "_rlnProbClass3", "_rlnProbClass4", "_rlnProbClass5", ...
    "_rlnProbClass6", "_rlnProbClass7", "_rlnProbClass8", "_rlnAccumMotionTotal", ...
"_rlnAccumMotionEarly", "_rlnAccumMotionLate", "_rlnCtfIceRingDensity", ...
